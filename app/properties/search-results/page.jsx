...
const SearchResultPage = async({searchParams:{location, propertyType}}) => {
    ...
    <>
        <section className="bg-blue-700 py-4">
          <div className="max-w-7xl mx-auto px-4 flex flex-col items-start-start sm:px-6 lg:px-8">
            <PropertySearchForm />
          </div>
        </section>
        <section className="px-4 py-6">
            <div className="container-xl lg:container m-auto px-4 py-6">
                ...
                {properties.length===0? ( <p>No search results</p> ):(
                    // one column in small screen by default, but three columns in md(medium)size 
